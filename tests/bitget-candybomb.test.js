...
test('normalizes an active CandyBomb card with pool, timer, and promo type', () => {
  ...
  assert.deepEqual(events, [{ source: 'bitget-candybomb-current', id: 'bitget-candybomb:12345', title: 'Тестовая акция', url: 'https://www.bitget.com/ru/events/candy-bomb/detail/12345', fields: [['Тип промо', 'Спот'], ['Пул', '12 500,5 USDT'], ['Заканчивается через', '0д 1ч 30м']] }]);
});
